...
class IdentifierRepositoryTest {
    ...
    fun resolveIdentifierTest() {
        ...
        runBlocking {
            ...
            assertThat(actualIdentifierDocument.getOrNull()?.identifierDocument?.id).isEqualTo(expectedIdentifier)
        }
        coVerify(exactly = 1) {
