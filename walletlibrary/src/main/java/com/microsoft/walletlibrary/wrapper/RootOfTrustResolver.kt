...
internal object RootOfTrustResolver {
    ...
    internal suspend fun resolveRootOfTrust(
        identifierDocument: IdentifierDocument,
        rootOfTrustResolver: RootOfTrustResolver? = null
    ): RootOfTrust {
        VerifiableCredentialSdk.linkedDomainsService.fetchAndVerifyLinkedDomains(identifierDocument.id, rootOfTrustResolver)
