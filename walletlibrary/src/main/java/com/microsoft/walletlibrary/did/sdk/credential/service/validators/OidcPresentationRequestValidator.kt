...
import com.microsoft.walletlibrary.did.sdk.util.Constants.MILLISECONDS_IN_A_SECOND
import com.microsoft.walletlibrary.did.sdk.util.Constants.SECONDS_IN_A_MINUTE
import com.microsoft.walletlibrary.did.sdk.util.controlflow.InvalidPinDetailsException
...
import com.microsoft.walletlibrary.did.sdk.util.controlflow.SubjectIdentifierTypeNotSupported
import com.microsoft.walletlibrary.did.sdk.util.controlflow.VpFormatNotSupported
...
internal class OidcPresentationRequestValidator @Inject constructor(private val jwtValidator: JwtValidator) :
    ...
    private fun checkForInputInPresentationRequest(request: PresentationRequest) {
        if (request.getPresentationDefinitions().credentialPresentationInputDescriptors.isEmpty())
