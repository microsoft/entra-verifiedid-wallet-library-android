...
import com.microsoft.walletlibrary.did.sdk.util.Constants.IDENTIFIER_PUBLIC_KEY_PURPOSE
import com.microsoft.walletlibrary.did.sdk.util.Constants.SIDETREE_PATCH_ACTION
...
@Singleton
internal class SidetreePayloadProcessor @Inject constructor(
