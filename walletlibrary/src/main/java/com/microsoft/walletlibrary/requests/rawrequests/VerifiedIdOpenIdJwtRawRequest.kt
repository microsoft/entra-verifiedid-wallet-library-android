...
import com.microsoft.walletlibrary.util.UnExpectedRequestType
...
internal class VerifiedIdOpenIdJwtRawRequest(
    ...
    override fun handleRawRequest(): VerifiedIdRequest {
        return when (rawRequest) {
            ...
            else -> throw UnExpectedRequestType("Provided Request is not the expected Presentation or Issuance Request")
        }
    }
}